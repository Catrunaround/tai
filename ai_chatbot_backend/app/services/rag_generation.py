...
async def generate_chat_response(
        ...
        top_k: int = 7,
        engine: Any = None,
        llm_mode: str = "openai",  # "local" for vLLM, "openai" for OpenAI API
        openai_model: str = "gpt-5.2",  # OpenAI model to use when llm_mode="openai"
    ...
    # If no engine is passed, dynamically get one based on llm_mode
    if engine is None:
